...
export const Cfb = class extends Mode {
    ...
    // Implement the getAnimation method for the Cfb class. The method should return an array of frames that represent the animation of the CFB mode.
    // IV goes from top to AES block
    // From left goes key to AES block
    // From AES block goes down to XOR
    // From left of XOR goes plaintext to XOR
    // From XOR goes down to ciphertext
    // The ciphertext is new IV
